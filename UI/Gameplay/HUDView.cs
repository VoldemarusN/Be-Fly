...
namespace UI
{
    ...
    {
        [SerializeField] private Image _oilIndicatorImage;
        [SerializeField] private Image _crashIndicatorImage;
        ...
        private void SetIndicatorActivity(bool isActive, Image indicatorImage)
        {
        ...
        private IEnumerator PingImageCoroutine(Image oilIndicatorImage)
        {
            while (true)
            {
