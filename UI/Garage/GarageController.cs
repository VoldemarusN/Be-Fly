...
namespace UI.View
{
    public class GarageController : IInitializable
    {
        ...
        public GarageController(PlaneScroller planeScroller, UpgradesController upgradesController, TextMeshProUGUI tmp, Storage storage,
            Button goButton, SceneLoader loader)
        {
            ...
            goButton.onClick.AddListener(() => loader.LoadLevelScene(storage.StorageData.LastLevel));
        }
        ...
        private void OnPlaneSwitched(PlaneType planeType)
        {
            ...
            _storage.StorageData.LastSelectedPlaneType = _planeScroller.CurrentPlaneType;
